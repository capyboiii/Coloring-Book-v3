...
"Naturally vary the structure and wording of each result. "
"You may optionally incorporate the number \"48\" when it fits naturally, "
"but do NOT include \"48\" in every result. "
"Use your judgment to decide when mentioning 48 pages or 48 coloring pages "
"makes the phrase more appealing and natural. "

"When connecting multiple elements, freely choose between commas (,) and \"&\". "
"Vary the formatting naturally instead of always following the same pattern. "
"Possible structures include \"A & B\", \"A, B, C\", \"A, B & C\", "
"\"A, B, C & D\", or other natural variations. "

"Examples: "
"\"Beaches, Palm Trees, Sea Turtles\", "
"\"48 Cute Dinosaurs, Volcanoes & Prehistoric Scenes\", "
"\"Unicorns, Magical Castles\", "
"\"Skulls, Ghosts, Gothic Scenes\", "
"\"48 coloring pages featuring Farm Animals & Country Life\", "
"\"Mermaids, Coral Reefs, Sea Life\", "
"\"Dragons & Enchanted Forests\", "
"\"Butterflies, Flowers, Garden Scenes & Nature Elements\". "

"Do not always use the same sentence structure. "
"Do not always include the number \"48\". "
...
"Choose exactly ONE phrase from the allowed list below that best fits the product and context. "
"Allowed phrases: "
...
"Use exactly ONE phrase from the list. "
"Do not modify, reorder, pluralize, combine, or rewrite any phrase. "
"Do not invent any phrase outside the allowed list."

"  BLOCK 4 = [Audience]. "
"Choose exactly ONE natural audience phrase based on the provided audience keyword. "
"Kids audience options: \"For Kids\", \"For Children\", \"For Young Children\", \"For Little Ones\", \"For Little Artists\", \"For Young Artists\", \"For Creative Kids\", \"For Young Creators\", \"For Budding Artists\", \"For Little Creators\", \"For Preschoolers\", \"For Early Learners\", \"For Young Learners\", \"For Little Learners\", \"Made for Kids\", \"Made for Little Artists\", \"Made for Young Artists\", \"Designed for Kids\", \"Perfect for Kids\", \"Fun for Kids\", \"Creative Fun for Kids\", \"A Fun Coloring Adventure\". "
"Adults audience options: \"For Adults\", \"For Adult Coloring\", \"For Adult Colorists\", \"For Grown-Ups\", \"Made for Adults\", \"Designed for Adults\", \"Perfect for Adults\", \"Creative Fun for Adults\", \"Relaxing Coloring for Adults\", \"Mindful Coloring for Adults\", \"A Coloring Escape for Adults\". "
"Use only phrases appropriate for the provided audience keyword. "
"Choose exactly ONE phrase. "
"Do not combine multiple audience phrases. "
"Do not invent or modify audience phrases. "
"If the audience keyword does not clearly match Kids or Adults, omit BLOCK 4."
