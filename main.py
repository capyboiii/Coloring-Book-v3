...
f"From keyword: {keyword}\n"
    ...
    "IMPORTANT KEYWORD INTERPRETATION:\n"
    "The provided keyword is a search-intent seed used to identify the niche, theme, "
    "subject, and buyer intent. It is NOT necessarily an exact-match phrase that must "
    "appear unchanged in every title.\n"
    "First identify the core theme behind the keyword, then generate meaningfully different "
    "subtopics within that theme.\n"
    "Do NOT mechanically repeat the full input keyword in every cover_title or seo_title.\n"
    "If the keyword contains generic product-format terms such as \"coloring sheets\", "
    "\"coloring pages\", \"coloring book\", \"coloring books\", \"printable\", "
    "\"printables\", or similar terms, extract the actual subject/theme and avoid repeating "
    "those generic terms in BLOCK 1 because the exact phrase \"Coloring Book\" is already required.\n"
    "Example: if the keyword is \"halloween coloring sheets\", natural BLOCK 1 examples include "
    "\"Friendly Halloween Ghosts Coloring Book\", \"Halloween Pumpkin Patch Coloring Book\", "
    "and \"Cute Halloween Monsters Coloring Book\".\n"
    "Do NOT write awkward phrases such as \"Halloween Coloring Sheets Coloring Book\".\n\n"

    "OUTPUT FORMAT:\n"
    "Return the result strictly as valid JSON using exactly this structure:\n"
    "[\n"
    "  {\n"
    ...
    "COVER_TITLE RULES:\n"
    "cover_title MUST consist of a short natural theme or subject phrase followed by the exact words "
    "\"Coloring Book\" and MUST end with \"Coloring Book\".\n"
    "Keep it short, clean, readable, appealing, and suitable for text displayed directly on a book cover.\n"
    "Focus on the specific subtopic rather than copying the full search keyword.\n"
    "Do not use hyphens, en dashes, em dashes, commas, colons, semicolons, ampersands, slashes, "
    "parentheses, quotation marks, apostrophes, or other special characters.\n"
    "Use letters, numbers, and spaces only.\n"
    "Do not add edition information, audience wording, page counts, SEO phrases, or promotional claims.\n"
    "Examples:\n"
    "\"Cozy Hawaii Vacation Coloring Book\"\n"
    ...
    "\"Coloring Book\".\n"
    "BLOCK 1 MUST end with \"Coloring Book\".\n"
    "BLOCK 1 should reflect the search intent and core theme of the provided keyword without "
    "forcing an awkward exact-match keyword phrase.\n"
    "Do NOT repeat generic product-format terms such as \"coloring sheets\", \"coloring pages\", "
    "\"printable coloring pages\", or similar wording immediately before \"Coloring Book\".\n"
    "Examples:\n"
    "\"Tropical Hawaii Coloring Book\"\n"
    ...
    "Every supporting element MUST be directly related to the specific topic in BLOCK 1.\n"
    "Use natural buyer-friendly phrases rather than a random list of SEO keywords.\n"
    "Prefer commas for most lists, but occasionally use \"&\" when it creates natural variation.\n"
    "Naturally vary the number of elements and sentence pattern throughout the batch.\n"
    ...
    "Do NOT always use \"&\".\n"
    "Do NOT reuse the exact same supporting keyword set anywhere else in the batch.\n"
    "Avoid vague fillers such as \"Fun Designs\", \"Cute Pictures\", \"Creative Pages\", "
    "\"Beautiful Art\", or similar generic wording when concrete visual content can be described.\n"
    "Do not repeat the complete input keyword unnecessarily in BLOCK 2.\n"
    "Examples:\n"
    "\"Beaches, Palm Trees, Sea Turtles\"\n"
    "\"Cute Dinosaurs, Volcanoes & Prehistoric Scenes\"\n"
    "\"Unicorns, Magical Castles\"\n"
    "\"Skulls, Ghosts, Gothic Scenes\"\n"
    "\"Farm Animals, Barns & Country Life\"\n"
    "\"Mermaids, Coral Reefs, Sea Life\"\n"
    "\"Dragons & Enchanted Forests\"\n"
    "\"Butterflies, Flowers, Garden Scenes & Nature Elements\"\n\n"

    "PAGE COUNT RULE:\n"
    "Do NOT invent a page count.\n"
    "Only mention a number such as \"48\", \"48 pages\", or \"48 coloring pages\" if the provided "
    "input keyword itself explicitly states that page count or another trusted input explicitly "
    ...
    "- Do not force the complete exact-match keyword into BLOCK 1 when doing so sounds repetitive or unnatural.\n"
    "- Never create constructions such as \"Coloring Sheets Coloring Book\" or \"Coloring Pages Coloring Book\".\n"
    "- Do not repeat \"Coloring Book\" anywhere outside BLOCK 1.\n"
    "- Supporting keywords must describe actual visual content appropriate to the topic.\n"
    "- Each seo_title must represent a meaningfully different coloring book concept.\n"
    "- Never reuse the exact same BLOCK 1 topic twice.\n"
    "- Never reuse the exact same BLOCK 2 supporting keyword set twice.\n"
    "- Avoid keyword stuffing and unnecessary repetition.\n"
    "- Do not use exaggerated claims such as \"Best\", \"Amazing\", \"Ultimate\", "
    "\"Number One\", \"Top\", \"Must Have\", or similar promotional superlatives.\n"
    ...
    "Topics must be appropriate for the selected target audience.\n"
    "Each topic should have a clearly distinguishable visual concept, setting, subject, activity, "
    "character group, or scene type.\n"
    "Do not create minor variations of the same concept merely by swapping one small object or adjective.\n"
    "Avoid excessive repetition of the same dominant subjects across the batch.\n"
    "For broad seasonal keywords, explore genuinely different subthemes such as characters, animals, "
